...
int main(int argc, char *argv[])
{
    ...
    printf("\n\t\t\t\t%X:%X:%X:%X:%X:%X\n", myarp.arp_na.sa_data[0], myarp.arp_na.sa_data[1], myarp.arp_na.sa_data[2], myarp.arp_na.sa_data[3], myarp.arp_na.sa_data[4], myarp.arp_na.sa_data[5]);
    return 0;
}
